...
// Support us by translating to other languages
// Please DO NOT use Google Translate, only translate it to
...
export default {
  ...
  'No more active conversations': 'Nincs több aktív csevegésed',
  Search: 'Keresés',
  ...
  'Roles': 'Szerepkörök',
  'Note': 'Megjegyzés',
  'Selected roles will be assigned to all users when they join, and you will be the creator.': 'A kiválasztott szerepkörök minden felhasználóhoz hozzárendelésre kerülnek, amikor csatlakoznak, és te leszel a létrehozó.',
